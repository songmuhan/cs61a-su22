...
(define (teacher-hold-class teacher)
  (define (student-attend-specific-class student)(student-attend-class student (teacher-get-class teacher)))
  (teacher-create 
    (teacher-get-name teacher) 
    (teacher-get-class teacher) 
    (map student-attend-specific-class (teacher-get-students teacher))
  )
)
